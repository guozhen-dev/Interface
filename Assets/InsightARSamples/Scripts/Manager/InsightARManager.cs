...
public class InsightARManager  : MonoBehaviour
{
    ...
    VisualRecognition _visualRecognition;
    ...
    public void OnTakePic()
    {
        ...
        fileText2Content = "TREE";
        string fileText2path = Application.persistentDataPath + "/typeofimage";
        File.WriteAllText(fileText2path, fileText2Content);
        string line = File.ReadAllText(Application.persistentDataPath + "/typeofimage");
        Log.Error("type","type",line.ToString());
    }
    ...
    void Classify()
    {
        ...
        String[] classifierName = new string[1];
        classifierName[0] = "me";
        String[] classifierID = new string[1];
        classifierID[0] = "default";
        string pathabc = Application.persistentDataPath + "/screenshot.jpg";
        if (!_visualRecognition.Classify(OnClassify , OnFail, pathabc, classifierName, classifierID, 0.5f))
            Log.Debug("ExampleVisualRecognition.Classify()", "Classify image failed!");
    }
